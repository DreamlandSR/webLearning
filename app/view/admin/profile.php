                    ...
                    <div class="col-md-4 text-center text-md-start">
                        ...
                        <div class="profile-img mb-3">
                            <img class="rounded img-fluid" 
                                ...
                                src="<?=BASEURL; ?>/img/frieren.jpeg" 
                                alt="Profile Picture" />
                        </div>
                        <!-- Links -->
                        <div class="mt-3">
                            <p class="text-uppercase fw-bold small">Work Link</p>
                            <p class="small"><a href="#">Website Link</a></p>
                            <p class="small"><a href="#">Bootsnipp Profile</a></p>
                            <p class="small"><a href="#">Bootply Profile</a></p>
                        </div>
                        <div class="mt-3">
                            <p class="text-uppercase fw-bold small">Skills</p>
                            <p class="small">Web Designer</p>
                            <p class="small">Web Developer</p>
                            <p class="small">WordPress</p>
                            <p class="small">WooCommerce</p>
                        </div>
                    </div>
                    <!-- Informasi Data Diri -->
                    <div class="col-md-8">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="fw-bold mb-1">Kshiti Ghelani</h5>
                                <p class="text-primary small mb-0">Web Developer and Designer</p>
                                <small>Rankings: <strong>8/10</strong></small>
                            </div>
                            <div class="mt-2">
                        ...
                        <div class="mt-3">
                            <div class="row">
                                <div class="col-6">
                                    <p class="fw-bold mb-1 small">User Id</p>
                                    <p class="small">Kshiti123</p>
                                    <p class="fw-bold mb-1 small">Name</p>
                                    <p class="small">Kshiti Ghelani</p>
                                    <p class="fw-bold mb-1 small">Email</p>
                                    <p class="small">kshitighelani@gmail.com</p>
                                </div>
                                <div class="col-6">
                                    <p class="fw-bold mb-1 small">Phone</p>
                                    <p class="small">123 456 7890</p>
                                    <p class="fw-bold mb-1 small">Profession</p>
                                    <p class="small">Web Developer and Designer</p>
                                </div>
                            </div>
                        </div>
                    </div>
